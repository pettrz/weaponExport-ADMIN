...
const linkInput = <input type="text" placeholder="Länk" data-bind="value: links, valueUpdate: 'afterkeydown'"></input>;
const linkError = <span data-bind="visible: links.hasError, text: links.validationMessage"></span>;
const linkBox = linkInput + linkError + <br/>;
ReactDOM.render(linkBox, document.getElementById('linkArea'));